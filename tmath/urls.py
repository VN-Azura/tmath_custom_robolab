...
from judge.views.api import sync_api
...
urlpatterns = [
    ...
    path('contest/<slug:contest>', include([
        ...
        path('/manage', contests.ContestManageView.as_view(), name='contest_manage'),
        # Problem
    ...
    path('organization/<int:pk>-<slug:slug>', include([
        ...
        path('/members_data', organization.OrganizationMemberData.as_view(), name='organization_members_data'),
